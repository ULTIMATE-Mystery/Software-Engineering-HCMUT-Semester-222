...
const active = {backgroundColor: '#708090', borderRadius: '1rem', height: '62px', width: '300px'}
const inactive = {}
              ...
              >
                  <Grid item sm={6} xs={13} md={6} lg={4.7}  >
                    ...
                    //   className="glassmorphism" 
                      style={{height: '650px', borderRadius: "1rem", 
                      boxShadow: "5px 5px 15px 0px rgba(0, 0, 0, 0.1)"
                    }} 
                    >
                              <CardContent  className="glassmorphism-new" >
                            
                                  <Typography gutterBottom variant="h5" sx={{ display: 'flex', alignItems: 'center' }}>
                                        <header style={{fontSize: 'x-large', color: '#94e2cd', fontWeight: '500', marginRight: '1rem'}}>MCPs</header>
                                        <TextField
                                         id="outlined-basic"
                                          label="Tìm kiếm" 
                                          variant="outlined"
                  ...
                  <Grid item xs={15} sm={10} md={10} lg={11.2} >
                      <Card style={{height: '650px', borderRadius: "1rem", 
                      boxShadow: "5px 5px 15px 0px rgba(0, 0, 0, 0.1)"
                      }
                    }>
                              <CardContent className="glassmorphism-new">
                              <Grid container columns={9.5} spacing={5}>
                                  <Grid item container columns={9.5} spacing={2}>
                                      <Grid item sm={9.5} md={9.5} xs={9.5} lg={9.5}>
                                          <CustomColor>
                                              <Typography gutterBottom variant="h6" component="h5" fontSize="x-large">
                                              ...
                                              className: 'glassmorphism',
                                                  ...
                                                  <DataGrid
                                                    ...
                                                    //   rowsPerPageOptions={[5]}
                                                      ...
                                                      rowHeight={50}
                                                      getCellClassName={(params: GridCellParams<Text, any, any, Text, Text>) => {
                                                        if (params.field === 'id' || 
                                                        params.field === 'starttime' 
                                                        || params.field === 'endtime' 
                                                        // || params.field === 'note'
                                                        || params.value == null) {
                                                          return '';
                                                        }
                                                        return (params.value === "Đang thực hiện" ?
                                                        'working' : (params.value === "Đã hoàn thành" ?
