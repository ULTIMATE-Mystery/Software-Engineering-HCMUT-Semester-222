...
![Use-case diagram](/Picture/uc diagram.png?raw=true)
...
|Preconditions| Người dùng đăng nhập vào tài khoản Back Officer và đang ở giao diện "Tổng
quan nhiệm vụ"|
...
|Exceptions Exception 1: Tại bước 5, tất cả MCPs đều vượt quá giới hạn chứa (>95%).
<br>Exception 2: Tại bước 7, không có nhân viên nào sẵn sàng làm việc.
<br>Exception 3: Tại bước 10, Back officer bấm nút hủy giao việc (CANCEL) →trở về lại bước 4 ở Normal flow|
##### Assign vehicles
