...
import PersonalInfo from "../../components/Worker/workerDetail.jsx";
...
const WorkerInfo = ({ setAllUserAccount, setUserLogin, userID }) => {
  ...
  const powerPermission =
    user?.type === "Back Officer" || user?.type === "Admin" ? 1 : 0;
  ...
  const renderButtonCell = ({ row, buttonFunc }) => {
    ...
    return (
      <Button
        ...
        color={
          buttonFunc === "Phân quyền" && !powerPermission
            ? "error"
            : "secondary"
        }
        variant="outlined"
      ...
      >
        <Typography color="white">{buttonFunc}</Typography>
      </Button>
    );
  };
  ...
  return (
    <Box m="20px">
      <Header title="THÔNG TIN NHÂN VIÊN" subtitle="Danh sách nhân viên" />
      {!detailInfor && (
        <Box
          m="40px 0 0 0"
          height="75vh"
              ...
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="left">
                    <Typography variant="h6">Loại hình nhân viên</Typography>
                  </TableCell>
                  <TableCell align="left">
                  ...
                  .map((row) => (
                    <TableRow padding="100px">
                      ...
                      <TableCell align="left" className={classes.tableCell}>
                        ...
                        {powerPermission
                          ? renderButtonCell({ row, buttonFunc: "Phân quyền" })
                          : undefined}
                      </TableCell>
                    </TableRow>
                  ))}
      ...
      {detailInfor && selectedRowData && (
        <div>
          ...
          >
            {/* Edit worker info */}
            <Box flex="0 1 50%" p="15px" borderRadius="4px">
              <WorkerEdit selectedRowData={selectedRowData} userID={userID} />
            </Box>

            {/* Detail infor display */}
            <Box flex="0 1 100%" p="15px" borderRadius="4px">
